...
class Tuner(Recoverable):
    ...
    --------
    Builtin tuners:
    :class:`~xcom.algorithms.hpo.hyperopt_tuner.hyperopt_tuner.HyperoptTuner`
    :class:`~xcom.algorithms.hpo.evolution_tuner.evolution_tuner.EvolutionTuner`
    :class:`~xcom.algorithms.hpo.smac_tuner.SMACTuner`
    :class:`~xcom.algorithms.hpo.gridsearch_tuner.GridSearchTuner`
    :class:`~xcom.algorithms.hpo.networkmorphism_tuner.networkmorphism_tuner.NetworkMorphismTuner`
    :class:`~xcom.algorithms.hpo.metis_tuner.mets_tuner.MetisTuner`
    :class:`~xcom.algorithms.hpo.ppo_tuner.PPOTuner`
    :class:`~xcom.algorithms.hpo.gp_tuner.gp_tuner.GPTuner`
    """
    ...
    def generate_parameters(self, parameter_id, **kwargs):
        ...
        The return value of this method will be received by trials via :func:`xcom.get_next_parameter`.
    ...
    def receive_trial_result(self, parameter_id, parameters, value, **kwargs):
        ...
        value
            Result from trial (the return value of :func:`xcom.report_final_result`).
        **kwargs
            Unstable parameters which should be ignored by normal users.
        """
