...
from xcom.core.config import cfg, load_cfg, reset_cfg
from xcom.core.io import cache_url


# URL prefix for pretrained models
_URL_WEIGHTS = "https://dl.fbaipublicfiles.com/xcom"

# URL prefix for model config files
_URL_CONFIGS = "https://raw.githubusercontent.com/facebookresearch/xcom/main/configs"

# Model weights download cache directory
_DOWNLOAD_CACHE = "/tmp/xcom-download-cache"
