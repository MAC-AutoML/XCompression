...
from xcom.core import utils

import xcom.core.logging as logging
import xcom.datasets.transforms as custom_transforms
from xcom.core.config import cfg
from xcom.core.utils import random_time_string
from xcom.datasets.utils import default_loader, is_image_file
...
class xcom_ImageFolder():
    def __init__(
        ...
        # Read all dataset
        logger.info("Constructing xcom_ImageFolder")
