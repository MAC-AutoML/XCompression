...
import xcom.datasets.transforms as transforms
...
def xcom_Cifar10(data_path, split, backend='custom', batch_size=256, num_workers=4):
    """
        xcom cifar10, generate dataloader from cifar10 train according split and beckend
