...
import logging
import torch
from xnas.common.graph_utils import build_module_graph
from xnas.compression.quantization.literal import QuantType, BN_FOLD_OP, BN_FOLD_TAG
from xnas.compression.quantization.observers import RecordingObserver
